<script>
  ...
  onMount(async () => {
    ...
    const response = await fetch('https://api.github.com/repos/nicksalt/ttpl/src/traffic/map-count-0.md');
  ...
  async function increment() {
    count++;
    await fetch('https://api.github.com/repos/nicksalt/ttpl/src/traffic/map-count-0.md', {
      method: 'POST',
